 ...
 * Runtime: 28 ms, faster than 92.68% of C online submissions for Find All Anagrams in a String.
 * Memory Usage: 9.5 MB, less than 67.07% of C online submissions for Find All Anagrams in a String.
*/
int* findAnagrams_b(char * s, char * p, int* returnSize)
{
    int alpha[26] = {0};
    int alphaCal[26] = {0};
    int pLen = strlen(p);
